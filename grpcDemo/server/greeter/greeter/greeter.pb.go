...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x12 \n" +
	"\bSayHello\x12\t.HelloReq\x1a\t.HelloResB\vZ\t./greeterb\x06proto3"
...
var file_proto_greeter_proto_goTypes = []any{
	(*HelloRes)(nil), // 0: HelloRes
	(*HelloReq)(nil), // 1: HelloReq
}
var file_proto_greeter_proto_depIdxs = []int32{
	1, // 0: Greeter.SayHello:input_type -> HelloReq
	0, // 1: Greeter.SayHello:output_type -> HelloRes
